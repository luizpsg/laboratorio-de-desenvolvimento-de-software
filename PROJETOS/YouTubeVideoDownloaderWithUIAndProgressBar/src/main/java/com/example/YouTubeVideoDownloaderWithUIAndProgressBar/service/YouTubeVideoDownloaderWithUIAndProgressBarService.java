...
public class YouTubeVideoDownloaderWithUIAndProgressBarService {
  ...
  public String downloadVideo(String videoUrl, String outputDirectory, String sessionId) {
    try {
      ...
      // String ytDlpPath = "yt-dlp"; // Usando o comando diretamente, assumindo que
      // está no PATH
      // Alternativamente, use o caminho completo para o executável:
      String ytDlpPath = "C:\\Users\\luizp\\AppData\\Local\\Programs\\Python\\Python312\\Scripts\\yt-dlp.exe";

      ProcessBuilder processBuilder = new ProcessBuilder(
          ytDlpPath,
          "--format", "bestvideo[height<=1080]+bestaudio/best",
          "-o", outputDirectory + File.separator + "%(title)s.%(ext)s",
          videoUrl,
